...
public class ControllerInterceptor {
    ...
    /**
     * 定义拦截规则：
     * 拦截 pers.xu.controller.SystemController 包下面的所有类中
     * 并且有@RequestMapping注解的方法。
     */
    @Pointcut("execution(* pers.xu.controller..*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
    public void log() {
    }
